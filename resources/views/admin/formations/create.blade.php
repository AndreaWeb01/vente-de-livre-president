...
@section('content')
<div class="mb-8">
    <h1 class="text-4xl font-bold text-gray-900 mb-2">Créer une nouvelle formation</h1>
    <p class="text-xl text-gray-600">
        Ajoutez une nouvelle formation à votre plateforme
    </p>
</div>
...
<div class="bg-white rounded-lg shadow">
    ...
    <form method="POST" action="{{ route('admin.formations.store') }}" enctype="multipart/form-data" class="p-6 space-y-6" novalidate>
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-2">
                ...
                <select id="type"
                    ...
                    <option value="en_ligne" {{ old('type') === 'en_ligne' ? 'selected' : '' }}>En ligne</option>
                    <option value="webinaire" {{ old('type') === 'webinaire' ? 'selected' : '' }}>Webinaire</option>
            ...
            <div class="space-y-2">
                <label for="image" class="block text-sm font-medium text-gray-700">Image de la formation *</label>
                <input type="file"
                       id="image"
                       name="image"
                       accept="image/*"
